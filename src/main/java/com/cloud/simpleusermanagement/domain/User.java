...
import com.cloud.simpleusermanagement.domain.common.AggregateRoot;
import com.cloud.simpleusermanagement.domain.event.DomainEvent;
import com.cloud.simpleusermanagement.domain.event.UserCreatedEvent;
import com.cloud.simpleusermanagement.domain.event.UserNameChangedEvent;
...
public final class User extends AggregateRoot {
    ...
    public User create(UserState state, String name,
                       String email, String individualUii, String contactNumber) {
    ...
    private User apply(UserCreatedEvent event) {
        ...
        this.individualUii = event.getIndividualUii();
